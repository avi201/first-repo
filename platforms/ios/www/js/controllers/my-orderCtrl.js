app.controller('my-orderCtrl', function($scope,$state, $ionicSideMenuDelegate, $ionicHistory,$ionicLoading,serviceXamarin) {
...
$ionicLoading.show({
    ...
    showDelay: 0
      ...
      serviceXamarin.crntOrderGet().then(function(objS){
                $ionicLoading.hide();                          
